...
<div class="row">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4 class="mb-3 header-title">فرم ویرایش وضعیت تکفل کارمندان</h4>

                <form class="form-horizontal" method="POST" action="{{ route('admin.takafols.update', $takafol->id) }}">
                    @csrf
                    @method('PATCH')
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <input name="relation_stats" type="text" class="form-control" id="inputEmail3" placeholder="وضعیت رابطه را وارد کنید" value="{{ old('relation_stats', $takafol->relation_stats) }}">
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-form-label">تعداد افراد تحت تکفل</label>
                        <input name="takafol_people_count_and_gender" type="text" class="form-control" id="inputEmail3" placeholder="تعداد افراد تحت تکفل را وارد کنید" value="{{ old('takafol_people_count_and_gender', $takafol->takafol_people_count_and_gender) }}">
                    </div>
