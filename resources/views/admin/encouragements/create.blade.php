...
<div class="row">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4 class="mb-3 header-title">فرم ایجاد مرخصی تشویقی</h4>

                <form class="form-horizontal" method="POST" action="{{ route('admin.encouragements.store') }}">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <input name="date" type="text" class="form-control" id="inputEmail3" placeholder="تاریخ تولد را وارد کنید" value="{{ old('date') }}">
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-form-label">توضیحات</label>
                        <input name="description" type="text" class="form-control" id="inputEmail3" placeholder="توضیحات را وارد کنید" value="{{ old('description') }}">
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-form-label">شماره مرخصی</label>
                        <input name="number" type="text" class="form-control" id="inputEmail3" placeholder="شماره مرخصی را وارد کنید" value="{{ old('number') }}">
                    </div>
