            ...
            <div class="card-body">
                ...
                <div class="mb-2">
                    <div class="row row-cols-sm-auto g-2 align-items-center">
                        <div class="col-12 text-sm-center">
                            <a href="{{ route('admin.sokoonats.create') }}" class="btn btn-primary"><i class="mdi mdi-plus-circle me-2"></i> ایجاد اطلاعات سکونت جدید</a>
                        </div>
                        <form action="">
                            <div class="col-12">
                ...
                <table id="demo-foo-addrow" class="table table-centered table-striped table-bordered mb-0 toggle-circle default footable-loaded footable" data-page-size="7">
                    ...
                    <tr>
                        ...
                        <th class="footable-visible footable-sortable">وضعیت سکونت<span class="footable-sort-indicator"></span></th>
                        <th data-hide="phone" class="footable-visible footable-sortable">وضعیت سکونت در منازل سازمانی<span class="footable-sort-indicator"></span></th>
                        <th data-hide="phone" class="footable-visible footable-sortable">آدرس کارمند<span class="footable-sort-indicator"></span></th>
                    ...
                    <tbody>
                    @foreach ($sokoonats as $sokoonat)
                    <tr class="footable-even" style="">
                        <td class="footable-visible"><span class="footable-toggle"></span>{{ $sokoonat->karmand->name }}</td>
                        <td class="footable-visible">{{ $sokoonat->homing_status }}</td>
                        <td class="footable-visible">{{ $sokoonat->homing_status_org }}</td>
                        ...
                        <td class="footable-visible footable-last-column d-flex">
                            <a class="btn btn-group btn-sm btn-success" href="{{ route('admin.sokoonats.show', $sokoonat->id) }}">
                                <i class="fas fa-eye"></i>
                            </a>
                            <span>
                                .
                            </span>
                            <a href="{{ route('admin.sokoonats.edit', $sokoonat->id) }}" class="btn btn-group btn-sm btn-primary">
                                <i class="fas fa-pencil-alt"></i>
                            </a>
                            <span>
                                .
                            </span>
                            <form action="{{ route('admin.sokoonats.destroy', $sokoonat->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
